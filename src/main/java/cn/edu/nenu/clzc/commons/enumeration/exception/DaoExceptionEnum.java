...
public enum DaoExceptionEnum {
	...
	AddRoleFaild("添加角色信息失败",10005),
	
	GetRolesFaild("获得角色信息失败",10006),
	
	AddSysRolePermissionFaild("添加用户角色权限失败",10007),
	
	DeleteSysRolePermissionFaild("删除用户角色权限失败",10008),
	
	DeleteUserFaild("删除用户失败",10009),
	
	InsertSysUserRoleFaild("插入用户角色信息用户失败",10010),
	
	SelectSysUserRoleFaild("选择用户角色信息用户失败",10011),
